...
console.log(`Check chain verified: ${definedChecks.length} defined release checks are wired, reference image/icon/system-surface and content-source gates are critical, and lint/build remain final.`);
