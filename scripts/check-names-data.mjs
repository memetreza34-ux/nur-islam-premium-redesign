...
for (const required of ['nur_name_favorites', 'nur_name_learned', 'NAMES_OF_ALLAH']) {
...
console.log('99 Names migration verified: 99 entries, unique IDs, persistence, route and styles.');
