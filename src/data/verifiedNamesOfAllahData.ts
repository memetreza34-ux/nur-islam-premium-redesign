...
/**
 * The individually Quran-sourced subset of the Names of Allah.
 *
 * This is an audit subset, not the public list: the app shows all 99 learning
 * names, and these are the rows whose evidence has already been written down.
 ...
 *
 * "Allah" carries no `legacyId` because it is not a numbered row of that
 * compilation, so this list is one entry longer than the part of the 99 it
 * covers. Counting entries here instead of counting the mapping overstates how
 * much of the learning list has been sourced.
 *
