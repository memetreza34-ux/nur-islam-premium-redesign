...
export const DHIKR_ROUTINES: DhikrRoutine[] = [
  ...
  },
  {
    ...
    description: '33-mal SubhanAllah, 33-mal Alhamdulillah und 34-mal Allahu Akbar vor dem Einschlafen.',
    source: 'Sahih al-Bukhari 3113; Sahih al-Bukhari 5361',
    note: 'Sahih al-Bukhari überliefert diesen Bericht in unterschiedlichen Wortlautvarianten. Diese App verwendet die klar belegte 33 Tasbih + 33 Tahmid + 34 Takbir-Form aus Bukhari 3113 und 5361 und erklärt andere authentische Varianten nicht für ungültig.',
    items: [
      {
