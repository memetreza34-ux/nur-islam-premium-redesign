...
export const learningLegacyFeatures: LegacyFeatureItem[] = [
  ...
  { id: 'prophets', title: 'Propheten', subtitle: 'Geschichten & Lehren', description: 'Elf Propheten mit Einordnung, Kernpunkten und Lehren.', icon: ScrollText, art: '/premium-assets/high-res-objects/mihrab-v2.webp' },
  ...
  { id: 'women', title: 'Frauen im Islam', subtitle: 'Bedeutende Persönlichkeiten', description: 'Frauen, die die islamische Geschichte geprägt haben.', icon: UserRound, art: '/premium-assets/high-res-objects/dua-hands-v2.webp' },
  { id: 'quiz', title: 'Islam-Quiz', subtitle: 'Wissen testen', description: 'Kurze Fragen, direkte Auswertung und lokaler Bestwert.', icon: CircleHelp, art: '/premium-assets/high-res-objects/quran-closed-v2.webp' },
  { id: 'hajj', title: 'Hajj & Umrah', subtitle: 'Ablauf verstehen', description: 'Stationen, Begriffe und Vorbereitung kompakt geordnet.', icon: Route, art: '/premium-assets/high-res-objects/kaaba-v2.webp' },
  { id: 'sunnah', title: 'Sunnah im Alltag', subtitle: 'Gute Gewohnheiten', description: 'Praktische, quellenorientierte Alltagserinnerungen.', icon: Bookmark, art: '/premium-assets/high-res-objects/sun-emblem-v2.webp' },
...
export const serviceLegacyFeatures: LegacyFeatureItem[] = [
  ...
  { id: 'standby', title: 'Gebetsanzeige', subtitle: 'Standby-Modus', description: 'Ruhige Live-Ansicht für das nächste Gebet mit optionalem Vollbild.', icon: Clock3, art: '/premium-assets/high-res-objects/qibla-compass-v2.webp' },
];
